...
class NetgearCM600Parser(ModemParser):
    ...
    ***REMOVED*** URL patterns to try for modem data
    ...
    def login(self, session, base_url, username, password) -> bool:
        ...
        """
        ***REMOVED*** CM600 uses HTTP Basic Auth which is handled automatically by the session
        ***REMOVED*** If credentials are provided, they're set in the session auth
        ***REMOVED*** No explicit login page to navigate
        return True
