...
class TestMB8611Authentication:
    ...
    def test_login_uses_auth_factory(self):
        ...
        ***REMOVED*** Mock AuthFactory to avoid actual authentication
...
class TestMB8611HNAPParsing:
    ...
    def test_parse_upstream_channels(self, mock_builder_class, mb8611_hnap_full_status):
        ...
        ***REMOVED*** Check first channel (ID 1)
        ...
        assert first_channel["frequency"] == 16_400_000  ***REMOVED*** 16.4 MHz
        ...
        ***REMOVED*** Check last channel (ID 4)
        ...
        assert last_channel["frequency"] == 35_600_000  ***REMOVED*** 35.6 MHz
