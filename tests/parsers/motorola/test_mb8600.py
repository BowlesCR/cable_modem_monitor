"""Tests for the Motorola MB8600 parser using HNAP protocol."""
...
from custom_components.cable_modem_monitor.parsers.motorola.mb8600 import (
    MotorolaMB8600HnapParser,
)
...
def hnap_full_status():
    ...
    fixture_path = os.path.join(os.path.dirname(__file__), "fixtures", "mb8600", "hnap_full_status.json")
...
def login_html():
    ...
    fixture_path = os.path.join(os.path.dirname(__file__), "fixtures", "mb8600", "Login.html")
    with open(fixture_path) as f:
        return f.read()
...
class TestDetection:
    ...
    def test_from_model_name(self):
        """Test detection from MB8600 in HTML."""
        html = "<html><body>Motorola MB8600 Cable Modem</body></html>"
        soup = BeautifulSoup(html, "html.parser")
        parser = MotorolaMB8600HnapParser()
    ...
    def test_from_model_number_with_spaces(self):
        ...
        html = "<html><body>Motorola MB 8600</body></html>"
        soup = BeautifulSoup(html, "html.parser")
        parser = MotorolaMB8600HnapParser()
    ...
    def test_from_serial_number(self):
        ...
        html = "<html><body>Serial: 2561-MB8600-30-1526</body></html>"
        soup = BeautifulSoup(html, "html.parser")
        parser = MotorolaMB8600HnapParser()
...
class TestAuthentication:
    ...
    def test_login_uses_auth_factory(self):
        ...
        auth_path = "custom_components.cable_modem_monitor.parsers.motorola.mb8600.AuthFactory"
...
class TestHnapParsing:
    ...
    def test_requires_session_and_base_url(self):
        ...
        error_msg = "MB8600 requires session and base_url"
    ...
    @patch("custom_components.cable_modem_monitor" ".parsers.motorola.mb8600.HNAPRequestBuilder")
    ...
    @patch("custom_components.cable_modem_monitor" ".parsers.motorola.8600.HNAPRequestBuilder")
...
class TestMetadata:
    ...
    def test_name(self):
        """Test parser name."""
        parser = MotorolaMB8600HnapParser()
        assert parser.name == "Motorola MB8600"
    ...
    def test_models(self):
        ...
        parser = MotorolaMB8600HnapParser()
        assert "MB8600" in parser.models
    ...
    def test_ofdm_capability(self):
        ...
        The MB8600 returns OFDM channels (modulation="OFDM PLC") in the same
...
class TestJsonHnapSupport:
    ...
    def test_json_hnap_login_fallback_to_xml(self):
        ...
        json_builder_path = "custom_components.cable_modem_monitor.parsers.motorola.mb8600.HNAPJsonRequestBuilder"
        auth_path = "custom_components.cable_modem_monitor.parsers.motorola.mb8600.AuthFactory"
    ...
    def test_both_json_and_xml_fail_with_auth_error(self):
        ...
        with (
            ...
            assert data["_diagnostic_context"]["parser"] == "MB8600 HNAP"
...
class TestSoftwareVersionParsing:
    ...
    def test_software_version_parsed(self, mock_builder_class, hnap_full_status):
        ...
        assert "system_info" in data
        assert data["system_info"]["software_version"] == "8600-19.3.15"
...
class TestRestartCapability:
    ...
    @patch("custom_components.cable_modem_monitor.parsers.motorola.mb8600.HNAPJsonRequestBuilder")
