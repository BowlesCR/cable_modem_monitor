...
class TestAutoDetection:
    ...
    def test_mb7621_detected_before_generic(self, swinfo_html):
        ...
        ***REMOVED*** Both parsers will match this HTML
        ...
        ***REMOVED*** MB7621 MUST match - this is the critical assertion
        assert mb7621_matches is True, "MB7621 parser should detect MB7621 modem"

        ***REMOVED*** Generic also matches (it checks title), which is fine
        ***REMOVED*** The issue is whether MB7621 is tried FIRST during detection
        assert generic_matches is True, "Generic also matches (expected)"

        ***REMOVED*** MB7621 has higher priority than Generic
    ...
    def test_anonymous_probing_would_find_mb7621(self, swinfo_html):
        ...
        ***REMOVED*** And MB7621 should have higher priority than Generic
        assert MotorolaMB7621Parser.priority > MotorolaGenericParser.priority
