...
## Modem Not Compatible (First Response)
...
## Modem Not Compatible (If They Provide Info)
...
## Modem Not Compatible (If It's Feasible to Add)

```markdown
Great news! I've looked at the HTML structure and it looks feasible to add support for the [Modem Model].

I've added it to the roadmap and will work on it in an upcoming release. I'll update issue #[number] when it's ready.
...
## Modem Not Compatible (If It's Not Feasible)
...
## Feature Request Response (Good Idea)
...
## Feature Request Response (Out of Scope)
...
## Question About Supported Modems
...
## Update Notification Template (For Big Releases)
