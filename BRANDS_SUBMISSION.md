...
├── icon@2x.png   # 512x512 - Required ✅
└── logo.png      # 512x512 - Optional but recommended ✅
```
...
└── custom_integrations/
    └── cable_modem_monitor/
        ├── icon.png      # 256x256
        ├── icon@2x.png   # 512x512
        └── logo.png      # 512x512 (optional)
```

### 3. Verify Icon Requirements
...
## Alternative: Quick Submit via GitHub UI
...
# Expected output:
# icon.png:    PNG image data, 256 x 256, 8-bit/color RGBA
# icon@2x.png: PNG image data, 512 x 512, 8-bit/color RGBA
# logo.png:    PNG image data, 512 x 512, 8-bit/color RGBA
