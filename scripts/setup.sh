...
***REMOVED*** Install Home Assistant first to resolve dependencies, then install dev tools
...
***REMOVED*** Install requests/aiohttp last, respecting HA's urllib3 constraint
